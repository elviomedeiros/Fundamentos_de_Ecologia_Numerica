...
# R Módulo 3.1 - Estatísticas descritivas e normalidade {#univ}
...
```{r rmd3banks, echo=FALSE, purl=FALSE, fig.cap="Comprimentos (cm) de 500 brotos do arbusto *Banksia ericifolia* de charnecas na Baía de Jervis, Austrália.", out.width = if (knitr::is_html_output()) "450px" else "10cm", fig.asp=1}
...
::: {.center data-latex=""}
Ou, baixe aqui o arquivo [brotos.xlsx](https://docs.google.com/spreadsheets/d/1iSJeR726dCc-ia3G5jzSBg__mSUsb-91/edit?usp=sharing&ouid=101766125969589673518&rtpof=true&sd=true)
:::
::::
...
knitr::purl(input = "3-03-1-rmd3_univ.Rmd", output = "script-3-03-1-rmd3_univ.txt", documentation = 0)
Script <- readLines("script-3-03-1-rmd3_univ.txt")
Script <- Script[Script != ""]
writeLines(Script, "script-3-03-1-rmd3_univ.txt")
cat(Script, sep = "\n")
```
