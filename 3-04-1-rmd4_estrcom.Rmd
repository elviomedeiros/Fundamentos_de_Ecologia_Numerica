...
# R Modulo 4.1 - Estrutura da Comunidade {#estrcom}
...
tamanho <- data.frame(
  Comando = c("range", "lenght", "n cols", "m linhas", "Tamanho", "Tamanho",
...
```{r 241rare, warning=FALSE, fig.show='hold', fig.cap="Curva de rafefação para sítios específicos. `q=0`, riqueza; `q=1`, diversidade de Shannon; `q=2`, diversidade de Simpson; `q=5`, equitabilidade."}
library(iNEXT)
