...
# R Modulo 2 - Tipos de Dados no R
...
```{r interface2, echo=FALSE, purl=FALSE, fig.cap="Interface típica do RStudio e nome dos paineis  ou janelas."}
...
```{r nucleos, echo=FALSE, purl=FALSE, fig.height=7,  fig.cap="Resumo visual dos tipos de dados no ambiente de programação R. (De: https://www.tutorialkart.com/r-tutorial/r-data-types)"}
knitr::include_graphics("imagens/nucleos.png")
```

```{r tipos, echo=FALSE, purl=FALSE, fig.height=7, fig.cap="Resumo visual dos tipos de dados no ambiente de programação R. (De: https://lhmet.github.io/adar-ebook/estrutura-dados.html)"}
...
```{r, eval=FALSE}
# Abrir o link para o site oficial do R
browseURL("https://chat.openai.com/")
```

```{r 22chat, echo=FALSE, fig.height=8, purl=FALSE, fig.cap="Usando o ChatGPT para pedir ajuda sobre o R."}
...
```{r 22wf, echo=FALSE, purl=FALSE, fig.cap="Exemplo de workflow para análises no R (modificada de [@RN2941])"}
...
knitr::purl(input = "02-rmd2_tipos.Rmd", output = "script-rmd2.txt", documentation = 0)
Script <- readLines("script-rmd2.txt")
Script <- Script[Script != ""]
writeLines(Script, "script-rmd2.txt")
cat(Script, sep = "\n")
```
