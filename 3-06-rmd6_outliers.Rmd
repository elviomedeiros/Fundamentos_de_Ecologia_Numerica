...
# R Modulo 6 - Análise de outliers baseada no desvio padrão do centróide {#outcentr}
...
knitr::include_graphics("imagens/Apdav_u0.jpg")
```
...
knitr::include_graphics("imagens/genis.jpg")
```
