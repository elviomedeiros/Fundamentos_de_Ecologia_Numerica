...
# R Modulo 4.3 - Estrutura do habitat {#estrhab}
...
```{r, eval=TRUE, results='hold', fig.show='hold', warning=FALSE, message=FALSE}
library(psych)
colnames(m_amb)
...
```{r erro_amb-select, eval=FALSE, results='hold'}
library(dplyr)
library(tidyr)
m_trab <- m_amb_part %>%
...
knitr::purl(input = "3-04-3-rmd4_amb.Rmd", output = "script-3-04-3-rmd4_amb.txt", documentation = 0)
Script <- readLines("script-3-04-3-rmd4_amb.txt")
Script <- Script[Script != ""]
writeLines(Script, "script-3-04-3-rmd4_amb.txt")
cat(Script, sep = "\n")
```
