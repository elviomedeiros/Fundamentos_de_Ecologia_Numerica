...
```{r 301ppbio, echo=FALSE, purl=FALSE, fig.cap="Parte da planilha de dados brutos do PPBio."}
knitr::include_graphics("imagens/ppbio.png")
```

```{r 301arqs, echo=FALSE, purl=FALSE}
arqs <- tibble::tribble(
...
```{r 301rm1, echo=FALSE, purl=FALSE, fig.cap="Associação entre a planilha de dados brutos do PPBio e o delineamento amostral do estudo."}
...
```{r 301asbim, echo=FALSE, purl=FALSE, fig.cap="*Astyanax bimaculatus*, a espécie mais comum da matriz de dados ppbio. Peru, by Eakins, R. Fonte: <https://www.fishbase.se/summary/Astianax-bimaculatus.html>"}
knitr::include_graphics("imagens/Asbim_u4.jpg")
```

```{r 301hmala, echo=FALSE, purl=FALSE, fig.cap="*Hoplias malabaricus*, espécie que cresce para se tornar um importante predador. Brazil, by Roselet, F.F.G. Fonte: <https://www.fishbase.se/summary/Hoplias-malabaricus.html>"}
knitr::include_graphics("imagens/Homal_u6.jpg")
```
...
```{r 301interface, echo=FALSE, purl=FALSE, fig.cap="Interface típica do RStudio e nome dos paineis  ou janelas."}
...
```{r, results='hide'}
library(readxl)
ppbio06 <- read_excel("D:/Elvio/OneDrive/Disciplinas/_EcoNumerica/5.Matrizes/ppbio06-peixes.xlsx",
                      sheet = "Sheet1",
                      na = "NA")
str(ppbio06)
class(ppbio06)
...
```{r, results='hide'}
library(readODS)
rebio23.ods <- read_ods("D:/Elvio/OneDrive/Disciplinas/_EcoNumerica/5.Matrizes/rebio23-zoopl_5-20.ods",
                   row_names = TRUE,
                   col_names = TRUE,
                   sheet = "densidade_hab_indL",
                   as_tibble = FALSE,
                   na = "n/a") # porque existem celulas vazias (n/a)
rebio23.ods <- na.omit(rebio23.ods)
str(rebio23.ods)
class(rebio23.ods)
rebio23.ods_ma <- as.matrix(rebio23.ods) #lê como uma matriz
str(rebio23.ods_ma)
...
knitr::purl(input = "01-rmd1_xls.Rmd", output = "script-rmd1.txt", documentation = 0)
Script <- readLines("script-rmd1.txt")
Script <- Script[Script != ""]
writeLines(Script, "script-rmd1.txt")
cat(Script, sep = "\n")
```
