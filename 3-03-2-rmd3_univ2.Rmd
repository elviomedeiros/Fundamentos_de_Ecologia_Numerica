...
# R Módulo 3.2 - Testes estatísticos {#univ2}
...
```{r rmd232tucu, echo=FALSE, purl=FALSE, fig.cap="Dados merísticos da espécie de peixe *Cichla ocellaris* (tucunaré amarelo) do reservatório da barragem  de Gramame, PB.", out.width = if (knitr::is_html_output()) "450px" else "10cm", fig.asp=1}
