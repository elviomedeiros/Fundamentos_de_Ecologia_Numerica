...
```{r 201mapa1, fig.width=8,  echo=FALSE, purl=FALSE, fig.cap="Área de estudo mostrando os estados do Rio Grande do Norte (RN), Paraíba (PB), Pernambuco (PE) e Alagoas (AL), principais sistemas fluviais e pontos de amostragem na região semiárida do Brasil. TA, açude Recanto; CP, riacho Cipó; CT, riacho Catureré; PC, riacho Poço da Cruz; MU, açude Mulungu e GU, açude Gurjão."}
...
```{r 201asbim, echo=FALSE, purl=FALSE, fig.cap="*Astyanax bimaculatus*, a espécie mais comum da matriz de dados ppbio. Peru, by Eakins, R. Fonte: <https://www.fishbase.se/summary/Astianax-bimaculatus.html>"}
knitr::include_graphics("imagens/spp/Asbim_u4.jpg")
```

```{r 201hmala, echo=FALSE, purl=FALSE, fig.cap="*Hoplias malabaricus*, espécie que cresce para se tornar um importante predador. Brazil, by Roselet, F.F.G. Fonte: <https://www.fishbase.se/summary/Hoplias-malabaricus.html>"}
...
```{r 201apdavis, echo=FALSE, purl=FALSE, fig.cap="*Apareiodon sp.*, importante espécie bentopelágica das bacias dos rios Jaguaribe e Paraíba. Brazil, by Ramos, T.P.A. Fonte: <https://www.fishbase.se/summary/Apareiodon-davisi.html>"}
knitr::include_graphics("imagens/spp/Apdav_u0.jpg")
```

```{r 201pgen, echo=FALSE, purl=FALSE, out.width = if (knitr::is_html_output()) "450" else "0.8\\textwidth", fig.asp = 1, fig.cap="*Pseudancistrus genisetiger*, uma espécie endêmica das bacias hidrográfcas do nordeste. By Medeiros, E.S.F. Fonte: Arquivo pessoal"}
...
```{r 201comcodes, echo=FALSE, purl=FALSE, fig.cap="Codificação para as variáveis, espécies de peixes, sítios de amostragem e período de amostragem."}
knitr::include_graphics("imagens/bases/com-codes.png")
```

```{r, echo=FALSE, purl=FALSE, fig.cap="Tabela 1. Abundância, percentual e frequência de ocorrência (F.O.) de espécies coletadas nos locais de estudo (codificados conforme a Figura \\@ref(fig:201comcodes)) no semiárido do Brasil. \\* = Espécies não nativas."}
...
```{r 201lista, fig.width=8, echo=FALSE, purl=FALSE, fig.cap=""}
knitr::include_graphics("imagens/bases/lista.png")
```

Tabela 2. Variáveis ambientais (average ± SD) coletadas nos locais de estudo no semiárido do Brasil.

```{r 201com1, echo=FALSE, out.width = if (knitr::is_html_output()) "450" else "0.8\\textwidth", fig.asp = 1, purl=FALSE, fig.cap=""}
...
```{r 201com2, echo=FALSE, purl=FALSE, fig.cap=""}
...
```{r 201mapa2, echo=FALSE, purl=FALSE, fig.cap=""}
knitr::include_graphics("imagens/bases/com-mapa.png")
```
...
```{r 201nmds, echo=FALSE, purl=FALSE, fig.cap=""}
...
```{r 201cca, echo=FALSE, purl=FALSE, fig.cap=""}
