...
```{r 201pgen, echo=FALSE, purl=FALSE, out.width="320px", fig.cap="*Pseudancistrus genisetiger*, uma espécie endêmica das bacias hidrográfcas do nordeste. By Medeiros, E.S.F. Fonte: Arquivo pessoal"}
...
```{r 201com1, echo=FALSE, out.height="600px", out.width="auto", purl=FALSE, fig.cap=""}
